                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <Nav.Link as={HashLink} smooth to="#abouts" className={activeLink === 'abouts' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('about')}>About</Nav.Link>
                        ...
                        <span className="navbar-text">
                            <div className="social-icon">
                                <a href="www.linkedin.com/in/aswin-sureshbabu"><img src={navIcon1} alt="LinkedIn" /></a>
